...
WORKDIR /workspace
RUN mkdir /home/puppeteer && groupadd puppeteer && \
    useradd -g puppeteer puppeteer && \
    chown -R puppeteer:puppeteer /workspace /home/puppeteer
